...
public class Ex01_Calendar {
	public static void main(String[] args) {
		...
		//객체를 만들때 new 키워드를 사용하지 않고 생성된 객체를 받아온다
		...
		//of()
		//특정 날짜와 시간 만들기
		LocalDateTime dt = LocalDateTime.of(2025,03,31,11,4);
		...
		//형식을 객체형태로 가지고 있음
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy년 MM월 dd일 EEEE a hh시 mm분");
